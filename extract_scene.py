...
def get_module_posix(file_name):
    ...
    #   - primero adentro del paquete que se encuentra este build,
    #   - si no relativo a donde se ejecuto el script, si se quiere acer
    #       de una de este forma con un path

    if __name__ == '__main__':
        # Se ejecutó como modulo, busco dentro de este
        module_name = __package__ + os.sep + file_name.replace(".py", "")
